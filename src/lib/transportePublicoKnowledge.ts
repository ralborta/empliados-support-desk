...
export const TRANSPORTE_PUBLICO_ARTICLES: TransporteKnowledgeArticle[] = [
  ...
  },
  {
    ...
    title: "Crear POI / etapas (checkpoints) para servicios",
    summary:
      "POI en Utilidades→Puntos de interés; se reutilizan como etapas en servicios de TP.",
    body: [
      "Según el manual de Transporte Público, los puntos de interés (checkpoints) se crean en Utilidades → Puntos de Interés (o ícono POI en el mapa).",
      "Pasos típicos de alta del POI:",
      "1) Agregar POI / Agregar punto.",
      "2) Clic en el mapa; ajustar radio de la geocerca.",
      "3) Nombre descriptivo (mejor intersección de calles).",
      "4) Guardar.",
      "Se crean una vez y se reutilizan en varios servicios como etapas. Radio recomendado en cabeceras: 30–50 m.",
      "También se pueden importar desde KMZ (Utilidades → Puntos de Interés → Importar / Cargar Google Earth).",
      "Cuando el cliente pregunta por el módulo (grupos, eventos, formas, tipo Depósito, import/export) → guía Puntos de interés.",
      "Cuando pregunta por etapas/tiempos dentro de un servicio o cómo armar el recorrido → guía Transporte Público (usando POI ya creados).",
      "Paradas de pasajeros son otra entidad (Código, Descripción, Coordenadas, Fotos): independientes de Puntos de interés.",
    ].join("\n"),
    source: { ...TRANSPORTE_PUBLICO_SOURCE, pages: "10" },
    relatedIds: ["tp-servicio-etapas-tiempos", "tp-glosario", "tp-paradas-vs-etapas"],
    restrictions: [
      "No afirmar que etapas/checkpoints son un módulo distinto de Utilidades→Puntos de interés; el manual TP los crea ahí.",
      "Paradas ≠ Puntos de interés (confirmado en relevamiento PI §9.4).",
    ],
    status: "available",
  },
  {
