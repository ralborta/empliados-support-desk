...
const PUSH_SUITES = [
  ...
  "verify-odometer-km-not-horometer.mjs",
  ...
  "verify-colloquial-post-tramite-ack.mjs",
  ...
  "verify-maintenance-information-guide.mjs",
  ...
  "verify-alertas-kb.mjs",
  "verify-paneles-kb.mjs",
  "verify-opciones-kb-v2.mjs",
