...
export const CLEAN_CAPABILITY_CATALOG: readonly CleanCapabilityDefinition[] = [
  ...
  capability("gps.get_status", "read", "gps", ["company", "unit"], false, ["no_company", "no_unit", "no_data"]),
  capability("odometer.prepare", "write_prepare", "odometer", ["company", "unit", "value", "date", "time"], true, ["no_company", "missing_fields", "anomaly"]),
  capability("odometer.update", "write_commit", "odometer", ["pendingOperation"], true, ["binding_mismatch", "write_disabled"]),
  capability("hourmeter.prepare", "write_prepare", "hourmeter", ["company", "unit", "value", "date", "time"], true, ["no_company", "missing_fields", "anomaly"]),
  capability("hourmeter.update", "write_commit", "hourmeter", ["pendingOperation"], true, ["binding_mismatch", "write_disabled"]),
  capability("maintenance.prepare", "write_prepare", "maintenance", ["company", "unit", "detail"], true, ["no_company", "missing_fields"]),
  capability("maintenance.create", "write_commit", "maintenance", ["pendingOperation"], true, ["binding_mismatch", "write_disabled"]),
  capability("certificate.prepare", "write_prepare", "certificate", ["company", "unit"], true, ["no_company", "no_unit"]),
