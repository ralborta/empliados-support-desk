...
describe("commander-v3 parity V2 (KB + fechas + derivación)", () => {
  it("prompt version bump 16i", () => {
    assert.match(COMMANDER_V3_PROMPT_VERSION, /2026-08-16i/);
  });
  ...
  it("prompt Commander no copia el árbol de decisión V1", async () => {
    ...
    assert.match(COMMANDER_V3_SYSTEM_PROMPT, /Estado\/GPS sin unidad|de qué unidad/i);
